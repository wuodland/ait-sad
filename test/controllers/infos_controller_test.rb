...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { Address: @info.Address, Age: @info.Age, First_name: @info.First_name, Last_name: @info.Last_name, PhoneNumber: @info.PhoneNumber, email: @info.email, gender: @info.gender } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { Address: @info.Address, Age: @info.Age, First_name: @info.First_name, Last_name: @info.Last_name, PhoneNumber: @info.PhoneNumber, email: @info.email, gender: @info.gender } }
